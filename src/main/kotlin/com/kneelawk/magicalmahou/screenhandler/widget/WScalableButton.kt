...
import com.kneelawk.magicalmahou.icon.MMIcons.BUTTON_DISABLED
import com.kneelawk.magicalmahou.icon.MMIcons.BUTTON_HOVERED
import com.kneelawk.magicalmahou.icon.MMIcons.BUTTON_REGULAR
...
class WScalableButton(
    ...
    override fun renderTooltip(matrices: MatrixStack, x: Int, y: Int, tX: Int, tY: Int) {
        ...
        screen as Screen
        screen.renderOrderedTooltip(matrices, tooltip.map(Text::asOrderedText), tX + x, tY + y)
    }
}